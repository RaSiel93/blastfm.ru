...
<html>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.ru/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Хостинг" /></a>
                </div>
                <div class="content">
            ...
            <div id="footer">
                ...
                <div class="copyright">Hostinger &copy; <? print date('Y'); ?>. Все права защищены </div>
